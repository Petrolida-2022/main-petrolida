...
@section('content')
  ...
  <div class="page-breadcrumb d-flex flex-column flex-md-row align-items-center mb-3">
    <div class="breadcrumb-title pe-md-3">Fracturing Fluid Design</div>
    <div class="ps-md-3 ms-md-auto mx-auto mx-md-0 mt-3 mt-md-0">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 p-0">
          ...
          <li class="breadcrumb-item active d-none d-sm-block" aria-current="page">Fracturing Fluid Design</li>
  ...
  <h6 class="mb-0 text-uppercase">Fracturing Fluid Design Team Data</h6>
  <hr>
  <div class="row">
            ...
            <div class="card-body">
              <div class="row g-3">
                ...
                <div class="col-sm-6">
                  ...
                  <p class="mb-0">
                    File name : 
                    <a href="https://api.petrolida.com/files/ffdc/{{ $team->file }}">
                      {{ $team->file }}
                    </a>
                  </p>
                </div>
            ...
            <div class="card-body">
              <div class="row g-3">
                ...
                <div class="col-sm-6">
                  ...
                  <p class="mb-0">
                    File name : 
                    <a href="https://api.petrolida.com/files/ffdc/{{ $member->file }}">
                      {{ $member->file }}
                    </a>
                  </p>
                </div>
      ...
      <div class="card shadow-sm border-0 overflow-hidden">
        ...
        <ul class="list-group list-group-flush">
          <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent border-top">
            Payment Slip
            <a href="https://api.petrolida.com/files/ffdc/{{ $team->payment }}" target="_blank">
              <span class="badge bg-primary rounded-pill">Download <i class="bi bi-download"></i></span>
            </a>
          </li>
          <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent">
            Leader Identity
            <a href="https://api.petrolida.com/files/ffdc/{{ $team->file }}" target="_blank">
              <span class="badge bg-primary rounded-pill">Download <i class="bi bi-download"></i></span>
            </a>
          </li>
          @foreach ($members as $member)
          <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent">
            ...
            <a href="https://api.petrolida.com/files/ffdc/{{ $member->file }}" target="_blank">
              <span class="badge bg-primary rounded-pill">Download <i class="bi bi-download"></i></span>
            </a>
          </li>
          @endforeach
