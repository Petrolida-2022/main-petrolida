...
@section('content')
  ...
  <h6 class="mb-0 text-uppercase">Stock Trading Team Data</h6>
  <hr>
  <div class="row">
            ...
            <div class="card-body">
              <div class="row g-3">
                ...
                <div class="col-sm-6">
                  ...
                  <p class="mb-0">
                    File name : 
                    <a href="https://api.petrolida.com/files/stc/{{ $team->file }}">
                      {{ $team->file }}
                    </a>
                  </p>
                </div>
            ...
            <div class="card-body">
              <div class="row g-3">
                ...
                <div class="col-sm-6">
                  ...
                  <p class="mb-0">
                    File name : 
                    <a href="https://api.petrolida.com/files/stc/{{ $member->file }}">
                      {{ $member->file }}
                    </a>
                  </p>
                </div>
      ...
      <div class="card shadow-sm border-0 overflow-hidden">
        ...
        <ul class="list-group list-group-flush">
          <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent border-top">
            Payment Slip
            <a href="https://api.petrolida.com/files/stc/{{ $team->payment }}" target="_blank">
              <span class="badge bg-primary rounded-pill">Download <i class="bi bi-download"></i></span>
            </a>
          </li>
          <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent">
            Leader Identity
            <a href="https://api.petrolida.com/files/stc/{{ $team->file }}" target="_blank">
              <span class="badge bg-primary rounded-pill">Download <i class="bi bi-download"></i></span>
            </a>
          </li>
          @foreach ($members as $member)
          <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent">
            ...
            <a href="https://api.petrolida.com/files/stc/{{ $member->file }}" target="_blank">
              <span class="badge bg-primary rounded-pill">Download <i class="bi bi-download"></i></span>
            </a>
          </li>
          @endforeach
